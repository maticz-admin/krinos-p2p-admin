...
export const addCurrency = async (reqData) => {
    try {
        ...
        let errors = err.response.data;//decodedata(err.response.data)
        if (errors.errors) {
            handleResp(err, 'err')
            return {
                status: 'failed',
...
export const preferredcurrencyList = async (reqData) => {
    try {
        const respData = await axios({
            'url': `/adminapi/preferred-currency`,
            'method': 'get',
            'params': {encode: encodedata(reqData)}
        })
...
export const addPreferredCurrency = async (reqData) => {
    try {
        const respData = await axios({
            'url': `/adminapi/preferred-currency`,
            'method': 'post',
...
export const updatePreferredCurrency = async (reqData) => {
    try {
        // console.log('reqData-----', reqData)
        const respData = await axios({
            'url': `/adminapi/preferred-currency`,
