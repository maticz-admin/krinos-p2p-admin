...
import CurrencyAddModal from "../partials/PreferredCurrencyAddModal";
import CurrencyUpdateModal from "../partials/PreferredCurrencyUpdateModal";

// import action
import { currencyList, preferredcurrencyList } from '../../actions/currency';
...
class PreferredCurrency extends Component {
    constructor(props) {
        super(props);
        this.columns = [
            {
    ...
    async fetchCurrencyList(reqData) {
        ...
        try {
            const { status, loading, message, result } = await preferredcurrencyList(reqData)
                ...
                <div className="d-flex" id="wrapper">
                    ...
                    <div id="page-content-wrapper">
                        <div className="container-fluid">
                            ...
                            ><FontAwesomeIcon icon={faPlus}  className="mr-1" /> Add Preferred Currency
                            </button>
                            <div className="clearfix" />
                            <h3 className="mt-2 text-secondary">Preferred Currency List</h3>
