...
import { Addoffertaghook } from '../../actions/P2PCreateaction';
...
class OffettagAddmodal extends React.Component {
    constructor() {
        super();
        this.state = {
    ...
    handleSubmit = async e => {
        ...
        try {
            ...
            var result = await Addoffertaghook(reqData);
            // this.setState({ 'loader': true })
    ...
    render() {
        ...
        const { markupPercentage, markPrice, maker_rebate, taker_fees, minPricePercentage, maxPricePercentage, maxQuantity, minQuantity, firstCurrencyId,
            firstFloatDigit, secondCurrencyId, secondFloatDigit, botstatus , name , description } = this.state.formValue
            ...
            <div>
                ...
                >
                    <Modal.Header closeButton>
                        <h4 className="modal-title">Add Offer Tag</h4>
                    </Modal.Header>
                    <Modal.Body>
...
export default OffettagAddmodal;
